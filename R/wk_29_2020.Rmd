...
plot <- ggplot() +
  ...
  geom_text(
    aes(x = 0, y = c(4.5,1.5), label = c("CIVILIANS","MILITARY")), 
    color = "white", size = 4, family = "Nasalization Rg", angle = 90
  ) +
  geom_text(
...
pdf_convert(pdf = here::here("plots","wk_29_2020.pdf"), format = "png", dpi = 600, filenames = here::here("plots","wk_29_2020_2.png"))
```

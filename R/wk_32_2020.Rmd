...
notes <- tribble(
  ~x, ~y, ~label,
  0, -4.5, "**Albania** is dependent on hydroelectricity, with a share in its production of 100%. Still, its topology has the potential to supply power from wind, sun, and soil.",
